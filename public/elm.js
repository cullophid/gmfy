...
var _user$project$Model$Game = F3(
	function (a, b, c) {
		return {name: a, description: b, id: c};
	});
...
var _user$project$View_Header$render = function (title) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('space-between')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Attributes$class('fa fa-home fa-2x')
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						A2(
...
var _user$project$View_GamesList$listItem = function (_p0) {
	var _p1 = _p0;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('list-group-item anim-from-left')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							...
							'#/games/',
							A2(_elm_lang$core$Basics_ops['++'], _p1.id, '/activities')))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$class('fa fa-circle-o fa-3x')
											]),
										_elm_lang$core$Native_List.fromArray(
											[]))
									])),
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text(_p1.description)
											]))
									]))
							]))
					]))
...
var _user$project$View_GamesList$render = function (_p2) {
	var _p3 = _p2;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('col-md-6 col-md-offset-3')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('list-group anim-list-stagger')
									]),
								A2(
									_elm_lang$core$List$map,
									_user$project$View_GamesList$listItem,
									A2(_elm_lang$core$Debug$log, 'GAMES', _p3.games)))
							]))
					])),
				A2(
				_elm_lang$html$Html$a,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('fixed-bottom-right btn btn-success anim-from-right anim-delay-500'),
						_elm_lang$html$Html_Attributes$href('#/games/new')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _user$project$View$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$View_Header$render('Games'),
				_user$project$View_GamesList$render(model)
			]));
};
